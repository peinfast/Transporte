    ...
    <body>
        ...
        <nav class="navbar navbar-default">
            <div class="navbar-header">
                ...
                <a href="index.php" class="navbar-brand"><img src="assets/img/logo.png" width="100"></a></div>

                <div class="collapse navbar-collapse navbar-ex1-collapse">
                    <ul class="nav navbar-nav">
                      <li><a href="?c=Transporte&a=Crud">Registro</a></li>
                      <li class="nav-item dropdown">
                        <a class="nav-link dropdown-toggle" href="#" id="navbarDropdown" role="button" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                          Area
                        </a>
                        <div class="dropdown-menu" aria-labelledby="navbarDropdown">
                          <a class="dropdown-item" href="?c=Transporte&a=L1bre">L1bre</a>
                          <div class="dropdown-divider"></div>
                          <a class="dropdown-item" href="?c=Transporte&a=Logistica">Logistica Inversa</a>
                          <div class="dropdown-divider"></div>
                          <a class="dropdown-item" href="?c=Transporte&a=Movilidad">Movilidad</a>
                          <div class="dropdown-divider"></div>
                          <a class="dropdown-item" href="?c=Transporte&a=Proyectos">Proyectos</a>
                          <div class="dropdown-divider"></div>
                          <a class="dropdown-item" href="?c=Transporte&a=Recibo">Recibo</a>
                          <div class="dropdown-divider"></div>
                          <a class="dropdown-item" href="?c=Transporte&a=Retail">Retail</a>
                        </div>
                      </li>
